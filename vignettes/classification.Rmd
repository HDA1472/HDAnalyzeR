...
First, let's start with a regularized regression LASSO model via `do_rreg()`. Exactly like in the previous vignette with the differential expression functions, we have to state the case and control(s) groups. We will only present the metrics and the variable importance plots from the function output.

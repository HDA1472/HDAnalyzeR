...
```{r}
qc_metadata <- qc_summary_metadata(clean_metadata, disease_palette = "cancers12")
qc_metadata$barplot_Sex
qc_metadata$distplot_Age
```
...
de_summary$proteins_df_up
de_summary$upset_plot_up
de_summary$proteins_df_down
